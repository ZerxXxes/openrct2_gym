class TrackBuilder:
    ...
    def take_action(self, action, current_position, current_direction):
        ...
        if action == 0:
            ...
            if success:
                # Move 2 steps forward and 2 steps left (x and y only)
                dx, dy = self.direction_vectors[current_direction]
                new_position[0] += 3 * dx
                new_position[1] += 3 * dy
            ...
            if success:
                # Move 2 steps forward and 2 steps left
                dx, dy = self.direction_vectors[current_direction]
                new_position[0] += 2 * dx
                new_position[1] += 2 * dy
            ...
            if success:
                # Move 2 steps forward and 2 steps right (x and y only)
                dx, dy = self.direction_vectors[current_direction]
                new_position[0] -= 3 * dx
                new_position[1] -= 3 * dy
            ...
            if success:
                # Move 3 steps forward, 3 steps left, and 3 steps up
                dx, dy = self.direction_vectors[current_direction]
                new_position[0] += 3 * dx
                new_position[1] += 3 * dy
            ...
            if success:
                # Move 3 steps forward, 3 steps right, and 3 steps up
                dx, dy = self.direction_vectors[current_direction]
                new_position[0] += 3 * dx
                new_position[1] += 3 * dy
            ...
            if success:
                # Move 3 steps forward, 3 steps left
                dx, dy = self.direction_vectors[current_direction]
                new_position[0] += 3 * dx
                new_position[1] += 3 * dy
            ...
            if success:
                # Move 3 steps forward, 3 steps right
                dx, dy = self.direction_vectors[current_direction]
                new_position[0] += 3 * dx
                new_position[1] += 3 * dy
